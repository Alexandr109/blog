        ...
        <div class="Page">
            <form method="POST" action="/account/register">
                ...
                <input type="password" name="password" placeholder="Password" maxlength="15"
                           pattern="[A-Za-z-0-9]{5,15}" title="More then 5 and lower then 15 latin letters or numbers" required>

                <br>

                <input type="text" name="name" placeholder="Name" maxlength="10" pattern="[A-Za-z-0-9]{4,10}"
                ...
                <div class="capdiv"><input type="text" class="capinp" name="captcha" placeholder="Captcha" maxlength="10"
                                           pattern="[0-9]{1,5}" title="Only nubmers" required>

                    <img src="/resource/captcha.php" class="capimg" alt="Captcha">

                </div>
                <br><input type="submit" name="enter" value="Registration">
